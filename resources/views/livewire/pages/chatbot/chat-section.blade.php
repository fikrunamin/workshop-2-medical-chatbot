<div class="grid grid-cols-1 flex flex-wrap content-between h-screen max-h-screen">
    <div class="bg-blue-500 py-10 shadow-lg px-5 flex w-full sticky top-0">
    ...
    <div class="grid grid-cols-1 flex-1">
        ...
        <div class="p-5 sticky bottom-0 bg-white w-full">
            <div class="relative">
                <button class="inline-flex items-center justify-center absolute right-0 top-0 h-full w-10 text-gray-400" wire:click="send_message()">
                    <span class="material-icons text-blue-400">
                        send
                    </span>
                </button>
                <textarea wire:model="my_message" wire:keydown.enter="send_message()" id="chatbox" type="text" name="chatbox" class="text-sm text-base placeholder-gray-500 pl-4 pr-10 rounded-3xl bg-blue-100 w-full py-2 focus:outline-none focus:border-blue-400 break-words h-10 max-h-20 resize-none overflow-y-auto" placeholder="Write a message" ></textarea>
            </div>
        </div>
    </div>
</div>