<div class="flex flex-row h-screen max-h-screen">
    <nav class="bg-blue-600 w-full justify-between flex flex-col px-5">
        <div class="mt-10 mb-10">
          <div class="flex items-center justify-center w-full ">
            <a href="javascript:;" wire:click="switch_page('search')" class="text-blue-500 shadow-lg bg-white rounded-full h-14 w-14 flex items-center justify-center duration-200">
                ...
                <ul>
                  <li class="mb-6 flex justify-center">
                    <a href="javascript:;" class="
                      ...
                      text-blue-500 shadow-lg bg-white rounded-full h-14 w-14 flex items-center justify-center duration-200
                      @else
                      text-white hover:text-blue-500 hover:shadow-lg hover:bg-white rounded-full h-14 w-14 flex items-center justify-center duration-200
                      @endif
