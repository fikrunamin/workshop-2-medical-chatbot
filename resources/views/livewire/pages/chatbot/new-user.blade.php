    ...
    <div class="grid grid-cols-1 mb-6 flex justify-center">
        ...
        <div class="flex justify-center text-center mb-10">
            <div class="@if (session('secondary_menu_visibility')) w-full max-w-full px-10 @else w-3/5 max-w-3/5 @endif">
                <h2 class="mb-3 text-white font-extrabold text-4xl">HI, {{strtoupper(auth()->user()->name)}}!</h2>
        ...
        <div class="flex justify-center text-center">
            <button class="@if (session('secondary_menu_visibility')) w-full max-w-full mx-10 @else w-1/2 max-w-1/2  @endif bg-white rounded-full shadow-md p-3 font-bold text-blue-500" wire:click="start_consultation()">
                START CONSULTATION
            </button>
        </div>
    </div>
